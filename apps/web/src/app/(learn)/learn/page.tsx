...
const completedLessons = learningModules.reduce((s, m) => s + m.completed, 0);
        ...
        <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-[var(--radius-card)] p-6 text-white mb-6 shadow-lg shadow-primary-500/20">
          <div className="flex items-start justify-between mb-4 gap-4">
            <div>
              ...
              <p className="text-xl font-bold">Level 2 — 投資基礎知識</p>
              <p className="text-primary-300 text-sm mt-1">下一課：ETF 的種類與選擇</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            {learningModules.map((module) => {
              ...
              const isActive = module.unlocked && !isComplete && module.completed > 0;
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {module.unlocked && !isComplete && (
                        <button className={`mt-3 text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors ${
                          isActive
